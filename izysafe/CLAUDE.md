...
- **Next:** Sprint 5 — next in the Sprint Plan (S0–S10); likely Sound Around / Two-way Call (Traccar SIM commands, §3.12) or School web admin. Plan + key decisions first, then build slice-by-slice. Optional un-built: `GET /children/{id}/location/latest`.
